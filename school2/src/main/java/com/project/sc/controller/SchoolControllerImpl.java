...
//-------------------------------------------------------------sb
	...
	public ModelAndView updateAttendance(@RequestParam("attendanceNo") String attendanceNo,
		...
		return new ModelAndView("redirect:/attendanceList.do").addObject("st_no", stNoStr)
				.addObject("startDate", startDateStr).addObject("endDate", endDateStr);
	}
...
//------------------------------------------------ds
    ...
    public ModelAndView listtc(HttpServletRequest request, HttpServletResponse response) throws Exception {
        List tcList = schoolService.listtc();
  ...
  //학생 상세 정보
    ...
    public ModelAndView tcInfo(HttpServletRequest request, HttpServletResponse response, @RequestParam("tc_No") String tcNo) throws Exception {
        SchoolVO teacher = schoolService.InfoStudent(tcNo);
