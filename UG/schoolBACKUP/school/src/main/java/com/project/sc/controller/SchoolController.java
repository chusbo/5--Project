...
public interface SchoolController {
	...
	// 기간별 출결 검색 메서드
	ModelAndView searchAttendance(String st_no, String startDate, String endDate) throws Exception;

	// 출결 상태 업데이트 메서드
	ModelAndView updateAttendance(String attendanceNo, String newStatus) throws Exception;
}
