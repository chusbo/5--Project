...
public interface SchoolService {
	...
	// 기간별 출결 검색 메서드
	List<SchoolVO> getAttendance(String st_no, Date startDate, Date endDate) throws Exception;
	
	// 출결 상태 업데이트 메서드
	void updateAttendance(String attendanceNo, String newStatus) throws Exception;
