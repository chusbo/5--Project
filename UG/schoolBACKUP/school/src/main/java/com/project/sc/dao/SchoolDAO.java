...
public interface SchoolDAO {
	...
	// 기간별 출결 검색 메서드
	List<SchoolVO> selectAttendance(Map<String, Object> paramMap) throws DataAccessException;

	// 출결 상태 업데이트 메서드
	void updateAttendance(Map<String, Object> paramMap) throws DataAccessException;
