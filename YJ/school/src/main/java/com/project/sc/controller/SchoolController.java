...
public interface SchoolController {
	//yj
	ModelAndView login(@ModelAttribute("school") SchoolVO school, RedirectAttributes rAttr, HttpServletRequest request, HttpServletResponse response) throws Exception;
	...
	public ModelAndView attendanceUpdate(HttpServletRequest request, HttpServletResponse response, String endDate, String tcNo) throws Exception;
	public ModelAndView attendance(HttpServletRequest request, HttpServletResponse response, String tcNo, String attendanceDate) throws Exception;
	public ModelAndView updateAttendance(String attendanceNo, String newStatus, String st_no, String startDate, String endDate, String attendanceDate, String tcNo) throws Exception;
