...
<nav class="navbar navbar-expand-lg navbar-light py-20">
    <div class="container-fluid d-flex align-items-center">
        ...
        <div class="d-flex align-items-center me-auto">
            <a href="${contextPath}/adminMain.do" class="hd">
...
<ul class="nav nav-pills">
    ...
    <li class="ni nav-item">
        <a href="${contextPath}/adminBoList.do" class="nav-link"><h4>학생정보</h4></a>
        <ul class="submenu">
            <li><a href="${contextPath}/adminBoList.do">학생 목록 조회</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">학생 신상 정보 열람</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">학생 상세정보 수정</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">학생 정보 삭제</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">새 학생 등록</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">개별 출석 현황 확인</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">기간 별 출결 검색</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">전과목 성적 확인</a><hr></li>
            <li><a href="${contextPath}/adminBoList.do">출결 수정</a></li>
        </ul>
    </li>
    <li class="ni nav-item">
        <a href="${contextPath}/adminBoList.do" class="nav-link"><h4>교사정보</h4></a>
        <ul class="submenu">
			<!-- 교사 목록 조회는 관리자 모드로 넣을것-->
            <li><a href="${contextPath}/adminBoList.do">교사 목록 조회</a><hr></li>
    ...
    <li class="ni nav-item">
		<!-- 교과 정보는 관리자 모드로 넣을것-->
        <a href="${contextPath}/adminBoList.do" class="nav-link"><h4>교과정보</h4></a>
    </li>
</ul>
