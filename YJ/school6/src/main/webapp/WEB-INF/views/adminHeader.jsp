...
<ul class="nav nav-pills">
    ...
    <li class="ni nav-item">
        <a href="${contextPath}/adminMain.do" class="nav-link"><h4>학생정보</h4></a>
        <ul class="submenu">
            ...
            <li><a href="${contextPath}/adminBoList.do">출결 수정</a><hr></li>
			<li><a href="${contextPath}/grades.do">학년 별 과목 평균</a><hr></li>
			<li><a href="${contextPath}/ranks.do">전교 석차</a></li>
        </ul>
    </li>
    <li class="ni nav-item">
        <a href="${contextPath}/adminMain.do" class="nav-link"><h4>교사정보</h4></a>
        <ul class="submenu">
